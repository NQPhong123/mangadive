    ...
    setState(() {
      _filteredMangas = _allMangas.where((manga) {
        return selectedCategoryNames
            .every((categoryName) => manga.genres.contains(categoryName));
      }).toList();
    });
  }
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (_categories
                        ...
                        .isNotEmpty) // Chỉ hiển thị nếu có categories có manga
                      Padding(
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return Padding(
                              ...
                              child: FilterChip(
                                label: Text(
                                    '${category.name} (${category.mangaCount})'),
                                selected: isSelected,
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return MangaCard(
                            ...
                            onTap: () async {
                              if (manga.isPremium) {
                                final isPremium =
                                    await _firebaseService.isUserPremium();
                                if (!isPremium) {
                                  showDialog(
                                    context: context,
                                    builder: (context) => AlertDialog(
                                      ...
                                      content: const Text(
                                          'Bạn cần nâng cấp lên gói Premium để đọc manga này.'),
                                      actions: [
                                        TextButton(
                                          onPressed: () =>
